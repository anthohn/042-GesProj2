    ...
    <div class="newAccountFormcontent">
        <form method="post">
            ...
            <table>
                <tr>
                    <td>
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" color="white" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                ...
                <tr>
                    <td>
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" color="white" fill="currentColor" class="bi bi-key" viewBox="0 0 16 16">
