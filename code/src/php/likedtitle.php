...
<div class="alltitlemainBlock">
	...
	<?php var_dump($ids) ?>
	<?php $musiques = $DB->query("SELECT * FROM t_musique WHERE idMusique IN (".implode.")"); ?>
