...
<div class="alltitlemainBlock">
	<?php $ids = array_keys($_SESSION["liked"]); ?>
	<?php var_dump($ids) ?>
	<?php $musics = $DB->query("SELECT * FROM t_music WHERE idMusic IN $ids"); ?>
