...
<?php 
	...
	if(isset($_GET['search']) && !empty($_GET['search'])) {
		...
		$artists = $DB->getSearchedArtists($search);
	...
	<form method="GET">
		<div class="searchBarInputContainer">
			...
			<div class="searchBarInput">
				<input autocomplete="off" type="text" name="search" id="search" placeholder="Rechercher une musique avec son titre, son auteur . . ."/>
			</div>
		</div>
	</form>
	<div class="result">
